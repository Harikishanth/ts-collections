...
export abstract class BaseCollectionError extends Error implements ICollectionError {
  code: string;
  context: ErrorContext;
  originalError?: Error;

  constructor(code: string, message: string, context: ErrorContext, originalError?: Error) {
    super(message);
