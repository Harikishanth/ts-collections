...
export const DefaultDetectors: Record<TypeCode, TypeDetector> = {
  ...
  [TypeCode.FUNCTION]: (val): val is ((...args: unknown[]) => unknown) => typeof val === "function",
  ...
  [TypeCode.UNDEFINED]: (_val): _val is undefined => typeof _val === "undefined",
  [TypeCode.ARRAY]: (val): val is unknown[] => Array.isArray(val),
  [TypeCode.OBJECT]: (val): val is object => val !== null && typeof val === "object",
